...
if($userID == $owner){
  ...
  $action = $userFullName." untagged a candidate as duplicate.";
}
...
if($userID != $owner){
$ownAction = "You untagged a candidate as duplicate.";
$activity = "INSERT INTO _activities(
              action,
              link,
              candidate_info,
...
$delete = "UPDATE candidate SET is_duplicate='' WHERE candidate_id='$candidateID'";
