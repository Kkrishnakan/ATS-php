                                                ...
                                                //  echo "QString2: ".$qString2."<br>";
                                                 ...
                                                 //  echo "QString2: ".$qString2."<br>";
                                                   ...
                                                   while($candidate = mysql_fetch_array($r2)){
                                                    ...
                                                    //echo "QString: ".$qString."<br>";
                                                  //  echo "QString2: ".$qString2."<br>";
                                                    $search = "SELECT * FROM candidate WHERE last_name LIKE '%$searchKeyword%' OR first_name LIKE '%$searchKeyword%' $criterion ORDER BY candidate_id DESC LIMIT 10";
                                                    ...
                                                    while($candidate = mysql_fetch_array($r2)){
                                                     ...
                                                     ?>
                                                         ...
                                                         //echo "QString: ".$qString."<br>";
                                                       //  echo "QString2: ".$qString2."<br>";
                                                         $search = "SELECT * FROM candidate WHERE first_name LIKE '%$firstName%' OR first_name LIKE '%$lastName%' $criterion ORDER BY candidate_id DESC LIMIT 10";
                                                         ...
                                                         while($candidate = mysql_fetch_array($r2)){
                                                          ...
                                                          ?>
                                                               ...
                                                               //echo "QString: ".$qString."<br>";
                                                             //  echo "QString2: ".$qString2."<br>";
                                                               $search = "SELECT * FROM candidate WHERE last_name LIKE '%$lastName%' OR last_name LIKE '%$firstName%' $criterion ORDER BY candidate_id DESC LIMIT 10";
