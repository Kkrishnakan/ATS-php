...
<br>
    <div class="invoice-area">
                                ...
                                if ($seniorTeamLeader['img'] == NULL){
                                  ...
                                  echo '<img src="'.$seniorTeamLeader['img'].'" alt="avatar" class="d-block ui-w-30 rounded-circle" alt="" style="width:60px;height:60px; object-fit: cover;">';
                                }
                                ...
                                if($userType == "Senior Team Leader"){
                                  ...
                                  $teamLeaderID = $teamLeader['user_id'];
                                    ...
                                    echo '<a href="module.php?m=profile&a=profileView&userID='.$teamLeader['user_id'].'">';
                                    echo '<div class="s-member">
                                          <div class="media align-items-center">';
                                    if ($teamLeader['img'] == NULL){
                                      echo '<img src="assets/images/profilephoto/default.jpg" alt="avatar" class="d-block ui-w-30 rounded-circle" alt="" style="width:60px;height:60px; object-fit: cover; ">';
                                    }else{
                                      echo '<img src="'.$teamLeader['img'].'" alt="avatar" class="d-block ui-w-30 rounded-circle" alt="" style="width:60px;height:60px; object-fit: cover;">';
                                    }
                                    echo '<div class="media-body ml-5">';
                                ...
                                if ($seniorTeamLeader['img'] == NULL){
                                  ...
                                  $teamLeader = mysqli_fetch_array($r2);
                                    ...
                                    echo '<div class="s-member">
                                          <div class="media align-items-center">';
                                    if ($teamLeader['img'] == NULL){
                                      echo '<img src="assets/images/profilephoto/default.jpg" alt="avatar" class="d-block ui-w-30 " alt="" style="border-radius:50%; width:60px;height:60px;">';
                                    }else{
                                      echo '<img src="'.$teamLeader['img'].'" alt="avatar" class="d-block ui-w-30 rounded-circle" alt="" style="width:60px;height:60px; object-fit: cover;">';
                                    }
                                    echo '<div class="media-body ml-5">';
...
<hr>
<button type="button" class="btn btn-block btn-primary">File a Leave</button>
<button type="button" class="btn btn-block btn-success">Check Leave Requests</button>
  </div>
  </div>
        <div class="card mt-2">
        <div class="card-body">
