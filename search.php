...
if( ($userType == "Finance") OR ($userType == "Recruiter") ){
  $criterion .= " AND is_duplicate != '127'";
}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            //  echo "QString2: ".$qString2."<br>";
                                              $search = "SELECT * FROM candidate WHERE phone_cell LIKE '%$searchKeyword%' $criterion ORDER BY candidate_id DESC LIMIT 15";

                                              //echo "Search: ".$search;
                                              //echo "<br>nString: ".$nString."<br>";
                                              $r2 = mysqli_query($dbc, $search);
                                              while($candidate = mysqli_fetch_array($r2)){

                                                $candidateID = $candidate['owner'];
                                                $r3 = mysqli_query($dbc, "SELECT * FROM user WHERE user_id='$candidateID'");
                                                $owner = mysqli_fetch_array($r3);
                                               ...
                                               ?>
                                                  ...
                                                  //echo "QString: ".$qString."<br>";
                                                //  echo "QString2: ".$qString2."<br>";
                                                  $search = "SELECT * FROM candidate WHERE (first_name LIKE '%$firstName%' AND last_name LIKE '%$lastName%' $criterion)
                                                  OR (first_name LIKE '%$lastName%' AND last_name LIKE '%$firstName%' $criterion) ORDER BY candidate_id DESC LIMIT 15";
                                                  ...
                                                  while($candidate = mysqli_fetch_array($r2)){
                                                   ...
                                                   ?>
                                                    ...
                                                    //echo "QString: ".$qString."<br>";
                                                  //  echo "QString2: ".$qString2."<br>";
                                                    $search = "SELECT * FROM candidate WHERE (last_name LIKE '%$searchKeyword%' $criterion)
                                                    OR (first_name LIKE '%$searchKeyword%' $criterion) ORDER BY last_name ASC LIMIT 15";
                                                    ...
                                                    while($candidate = mysqli_fetch_array($r2)){
                                                     ...
                                                     ?>
                                                         ...
                                                         //echo "QString: ".$qString."<br>";
                                                       //  echo "QString2: ".$qString2."<br>";
                                                         $search = "SELECT * FROM candidate WHERE (first_name LIKE '%$firstName%' $criterion)
                                                         OR (first_name LIKE '%$lastName%' $criterion) ORDER BY first_name ASC LIMIT 15";
                                                         ...
                                                         while($candidate = mysqli_fetch_array($r2)){
                                                          ...
                                                          ?>
                                                               ...
                                                               //echo "QString: ".$qString."<br>";
                                                             //  echo "QString2: ".$qString2."<br>";
                                                               $search = "SELECT * FROM candidate WHERE (last_name LIKE '%$lastName%' $criterion)
                                                               OR (last_name LIKE '%$firstName%' $criterion) ORDER BY last_name ASC LIMIT 15";
